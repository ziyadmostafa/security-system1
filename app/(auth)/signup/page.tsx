...
// Signup Page — /signup
//
// PIXEL-PERFECT MATCH with Login page design:
// Same cyber security background, glassmorphism effects,
// animations, and visual design language.
...
// ── Project Logo (same as Login Page /logo.png) ──
...
// ── Lock Icon for left side (from login page) ──
...
// ── Small Lock Icon for password fields (from login page) ──
...
// ── Cyber Background (complete redesign from login page) ──
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6">
        ...
        <div className="relative flex items-center justify-center mb-12 mt-4">
          ...
          <div className="absolute -left-24 top-1/2 -translate-y-1/2" style={{ marginTop: '78px' }}>
            <LockSideIcon />
          </div>
          
          {/* Main Project Logo (replaced from reference design) */}
          <div className={`${styles['animate-fade-in']}`} style={{ marginTop: '118px' }}>
            <ProjectLogo />
          </div>
        </div>
        ...
        <div className="w-full max-w-[340px]">
          <form onSubmit={handleSignup} className="flex flex-col">
            ...
            <button
              type="submit"
              className="w-full h-[52px] text-white text-[16px] font-bold rounded-[26px] focus:outline-none transition-all duration-300 mb-4"
              style={{
                background: 'linear-gradient(135deg, #00aaff 0%, #0066cc 100%)',
                border: '2px solid #00d4ff',
                boxShadow: '0 0 25px rgba(0, 170, 255, 0.5), inset 0 0 12px rgba(0, 100, 200, 0.3)',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = 'linear-gradient(135deg, #00ccff 0%, #0088ee 100%)';
                e.currentTarget.style.boxShadow = '0 0 35px rgba(0, 170, 255, 0.7), inset 0 0 15px rgba(0, 100, 200, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'linear-gradient(135deg, #00aaff 0%, #0066cc 100%)';
                e.currentTarget.style.boxShadow = '0 0 25px rgba(0, 170, 255, 0.5), inset 0 0 12px rgba(0, 100, 200, 0.3)';
              }}
            >
              CREATE ACCOUNT
            </button>
            ...
            <div className="text-center">
              ...
              <Link 
                href="/login" 
                className="text-white text-sm font-semibold hover:text-blue-200 underline underline-offset-2 transition-colors"
              >
                Login
              </Link>
            </div>
